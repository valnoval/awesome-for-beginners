...
If you are a maintainer for open-source projects, add the label `first-timers-only` (or similar) to your project and list it here so people can find it. For people with similar interests, the label 'good first issue' will also be useful.
